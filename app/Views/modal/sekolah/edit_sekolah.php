        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
               ...
               <div class="input-group input-group-outline mb-3">
                    ...
                    <input type="text" id="edit_nama_sekolah" name="nama_sekolah" class="form-control" required>
                </div>
                <div class="input-group input-group-outline form-floating mb-3">
                    <textarea class="form-control" id="edit_alamat" name="nama_sekolah" placeholder="Alamat" required></textarea>
                </div>
                ...
                <div class="input-group input-group-static mb-3">
                    <select id="edit_is_active" class="form-control form-select" name="is_active" required>
